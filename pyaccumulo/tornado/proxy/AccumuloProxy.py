...
class Client(Iface):
  ...
  def send_update(self, writer, cells):
    oprot = self._oprot_factory.getProtocol(self._transport)
    oprot.writeMessageBegin('update', TMessageType.ONEWAY, self._seqid)
    args = update_args()
    args.writer = writer
    args.cells = cells
    args.write(oprot)
...
class Processor(Iface, TProcessor):
  ...
  def process_login(self, seqid, iprot, oprot):
    ...
    result = login_result()
    try:
      result.success = yield gen.maybe_future(self._handler.login(args.principal, args.loginProperties))
  ...
  def process_addConstraint(self, seqid, iprot, oprot):
    ...
    result = addConstraint_result()
    try:
      result.success = yield gen.maybe_future(self._handler.addConstraint(args.login, args.tableName, args.constraintClassName))
  ...
  def process_addSplits(self, seqid, iprot, oprot):
    ...
    result = addSplits_result()
    try:
      yield gen.maybe_future(self._handler.addSplits(args.login, args.tableName, args.splits))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_attachIterator(self, seqid, iprot, oprot):
    ...
    result = attachIterator_result()
    try:
      yield gen.maybe_future(self._handler.attachIterator(args.login, args.tableName, args.setting, args.scopes))
  ...
  def process_checkIteratorConflicts(self, seqid, iprot, oprot):
    ...
    result = checkIteratorConflicts_result()
    try:
      yield gen.maybe_future(self._handler.checkIteratorConflicts(args.login, args.tableName, args.setting, args.scopes))
    except AccumuloSecurityException as ouch1:
      result.ouch1 = ouch1
    except AccumuloException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_clearLocatorCache(self, seqid, iprot, oprot):
    ...
    result = clearLocatorCache_result()
    try:
      yield gen.maybe_future(self._handler.clearLocatorCache(args.login, args.tableName))
  ...
  def process_cloneTable(self, seqid, iprot, oprot):
    ...
    result = cloneTable_result()
    try:
      yield gen.maybe_future(self._handler.cloneTable(args.login, args.tableName, args.newTableName, args.flush, args.propertiesToSet, args.propertiesToExclude))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_compactTable(self, seqid, iprot, oprot):
    ...
    result = compactTable_result()
    try:
      yield gen.maybe_future(self._handler.compactTable(args.login, args.tableName, args.startRow, args.endRow, args.iterators, args.flush, args.wait, args.compactionStrategy))
    except AccumuloSecurityException as ouch1:
      result.ouch1 = ouch1
  ...
  def process_cancelCompaction(self, seqid, iprot, oprot):
    ...
    result = cancelCompaction_result()
    try:
      yield gen.maybe_future(self._handler.cancelCompaction(args.login, args.tableName))
    except AccumuloSecurityException as ouch1:
      result.ouch1 = ouch1
    except TableNotFoundException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_createTable(self, seqid, iprot, oprot):
    ...
    result = createTable_result()
    try:
      yield gen.maybe_future(self._handler.createTable(args.login, args.tableName, args.versioningIter, args.type))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_deleteTable(self, seqid, iprot, oprot):
    ...
    result = deleteTable_result()
    try:
      yield gen.maybe_future(self._handler.deleteTable(args.login, args.tableName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_deleteRows(self, seqid, iprot, oprot):
    ...
    result = deleteRows_result()
    try:
      yield gen.maybe_future(self._handler.deleteRows(args.login, args.tableName, args.startRow, args.endRow))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_exportTable(self, seqid, iprot, oprot):
    ...
    result = exportTable_result()
    try:
      yield gen.maybe_future(self._handler.exportTable(args.login, args.tableName, args.exportDir))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_flushTable(self, seqid, iprot, oprot):
    ...
    result = flushTable_result()
    try:
      yield gen.maybe_future(self._handler.flushTable(args.login, args.tableName, args.startRow, args.endRow, args.wait))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getDiskUsage(self, seqid, iprot, oprot):
    ...
    result = getDiskUsage_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getDiskUsage(args.login, args.tables))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getLocalityGroups(self, seqid, iprot, oprot):
    ...
    result = getLocalityGroups_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getLocalityGroups(args.login, args.tableName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getIteratorSetting(self, seqid, iprot, oprot):
    ...
    result = getIteratorSetting_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getIteratorSetting(args.login, args.tableName, args.iteratorName, args.scope))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getMaxRow(self, seqid, iprot, oprot):
    ...
    result = getMaxRow_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getMaxRow(args.login, args.tableName, args.auths, args.startRow, args.startInclusive, args.endRow, args.endInclusive))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getTableProperties(self, seqid, iprot, oprot):
    ...
    result = getTableProperties_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getTableProperties(args.login, args.tableName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_importDirectory(self, seqid, iprot, oprot):
    ...
    result = importDirectory_result()
    try:
      yield gen.maybe_future(self._handler.importDirectory(args.login, args.tableName, args.importDir, args.failureDir, args.setTime))
    except TableNotFoundException as ouch1:
      result.ouch1 = ouch1
    except AccumuloException as ouch3:
      result.ouch3 = ouch3
  ...
  def process_importTable(self, seqid, iprot, oprot):
    ...
    result = importTable_result()
    try:
      yield gen.maybe_future(self._handler.importTable(args.login, args.tableName, args.importDir))
  ...
  def process_listSplits(self, seqid, iprot, oprot):
    ...
    result = listSplits_result()
    try:
      result.success = yield gen.maybe_future(self._handler.listSplits(args.login, args.tableName, args.maxSplits))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_listTables(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = listTables_result()
    result.success = yield gen.maybe_future(self._handler.listTables(args.login))
  ...
  def process_listIterators(self, seqid, iprot, oprot):
    ...
    result = listIterators_result()
    try:
      result.success = yield gen.maybe_future(self._handler.listIterators(args.login, args.tableName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_listConstraints(self, seqid, iprot, oprot):
    ...
    result = listConstraints_result()
    try:
      result.success = yield gen.maybe_future(self._handler.listConstraints(args.login, args.tableName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_mergeTablets(self, seqid, iprot, oprot):
    ...
    result = mergeTablets_result()
    try:
      yield gen.maybe_future(self._handler.mergeTablets(args.login, args.tableName, args.startRow, args.endRow))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_offlineTable(self, seqid, iprot, oprot):
    ...
    result = offlineTable_result()
    try:
      yield gen.maybe_future(self._handler.offlineTable(args.login, args.tableName, args.wait))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_onlineTable(self, seqid, iprot, oprot):
    ...
    result = onlineTable_result()
    try:
      yield gen.maybe_future(self._handler.onlineTable(args.login, args.tableName, args.wait))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_removeConstraint(self, seqid, iprot, oprot):
    ...
    result = removeConstraint_result()
    try:
      yield gen.maybe_future(self._handler.removeConstraint(args.login, args.tableName, args.constraint))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_removeIterator(self, seqid, iprot, oprot):
    ...
    result = removeIterator_result()
    try:
      yield gen.maybe_future(self._handler.removeIterator(args.login, args.tableName, args.iterName, args.scopes))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_removeTableProperty(self, seqid, iprot, oprot):
    ...
    result = removeTableProperty_result()
    try:
      yield gen.maybe_future(self._handler.removeTableProperty(args.login, args.tableName, args.property))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_renameTable(self, seqid, iprot, oprot):
    ...
    result = renameTable_result()
    try:
      yield gen.maybe_future(self._handler.renameTable(args.login, args.oldTableName, args.newTableName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_setLocalityGroups(self, seqid, iprot, oprot):
    ...
    result = setLocalityGroups_result()
    try:
      yield gen.maybe_future(self._handler.setLocalityGroups(args.login, args.tableName, args.groups))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_setTableProperty(self, seqid, iprot, oprot):
    ...
    result = setTableProperty_result()
    try:
      yield gen.maybe_future(self._handler.setTableProperty(args.login, args.tableName, args.property, args.value))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_splitRangeByTablets(self, seqid, iprot, oprot):
    ...
    result = splitRangeByTablets_result()
    try:
      result.success = yield gen.maybe_future(self._handler.splitRangeByTablets(args.login, args.tableName, args.range, args.maxSplits))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_tableExists(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = tableExists_result()
    result.success = yield gen.maybe_future(self._handler.tableExists(args.login, args.tableName))
  ...
  def process_tableIdMap(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = tableIdMap_result()
    result.success = yield gen.maybe_future(self._handler.tableIdMap(args.login))
  ...
  def process_testTableClassLoad(self, seqid, iprot, oprot):
    ...
    result = testTableClassLoad_result()
    try:
      result.success = yield gen.maybe_future(self._handler.testTableClassLoad(args.login, args.tableName, args.className, args.asTypeName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_pingTabletServer(self, seqid, iprot, oprot):
    ...
    result = pingTabletServer_result()
    try:
      yield gen.maybe_future(self._handler.pingTabletServer(args.login, args.tserver))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getActiveScans(self, seqid, iprot, oprot):
    ...
    result = getActiveScans_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getActiveScans(args.login, args.tserver))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getActiveCompactions(self, seqid, iprot, oprot):
    ...
    result = getActiveCompactions_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getActiveCompactions(args.login, args.tserver))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getSiteConfiguration(self, seqid, iprot, oprot):
    ...
    result = getSiteConfiguration_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getSiteConfiguration(args.login))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getSystemConfiguration(self, seqid, iprot, oprot):
    ...
    result = getSystemConfiguration_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getSystemConfiguration(args.login))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getTabletServers(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = getTabletServers_result()
    result.success = yield gen.maybe_future(self._handler.getTabletServers(args.login))
  ...
  def process_removeProperty(self, seqid, iprot, oprot):
    ...
    result = removeProperty_result()
    try:
      yield gen.maybe_future(self._handler.removeProperty(args.login, args.property))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_setProperty(self, seqid, iprot, oprot):
    ...
    result = setProperty_result()
    try:
      yield gen.maybe_future(self._handler.setProperty(args.login, args.property, args.value))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_testClassLoad(self, seqid, iprot, oprot):
    ...
    result = testClassLoad_result()
    try:
      result.success = yield gen.maybe_future(self._handler.testClassLoad(args.login, args.className, args.asTypeName))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_authenticateUser(self, seqid, iprot, oprot):
    ...
    result = authenticateUser_result()
    try:
      result.success = yield gen.maybe_future(self._handler.authenticateUser(args.login, args.user, args.properties))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_changeUserAuthorizations(self, seqid, iprot, oprot):
    ...
    result = changeUserAuthorizations_result()
    try:
      yield gen.maybe_future(self._handler.changeUserAuthorizations(args.login, args.user, args.authorizations))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_changeLocalUserPassword(self, seqid, iprot, oprot):
    ...
    result = changeLocalUserPassword_result()
    try:
      yield gen.maybe_future(self._handler.changeLocalUserPassword(args.login, args.user, args.password))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_createLocalUser(self, seqid, iprot, oprot):
    ...
    result = createLocalUser_result()
    try:
      yield gen.maybe_future(self._handler.createLocalUser(args.login, args.user, args.password))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_dropLocalUser(self, seqid, iprot, oprot):
    ...
    result = dropLocalUser_result()
    try:
      yield gen.maybe_future(self._handler.dropLocalUser(args.login, args.user))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_getUserAuthorizations(self, seqid, iprot, oprot):
    ...
    result = getUserAuthorizations_result()
    try:
      result.success = yield gen.maybe_future(self._handler.getUserAuthorizations(args.login, args.user))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_grantSystemPermission(self, seqid, iprot, oprot):
    ...
    result = grantSystemPermission_result()
    try:
      yield gen.maybe_future(self._handler.grantSystemPermission(args.login, args.user, args.perm))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_grantTablePermission(self, seqid, iprot, oprot):
    ...
    result = grantTablePermission_result()
    try:
      yield gen.maybe_future(self._handler.grantTablePermission(args.login, args.user, args.table, args.perm))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_hasSystemPermission(self, seqid, iprot, oprot):
    ...
    result = hasSystemPermission_result()
    try:
      result.success = yield gen.maybe_future(self._handler.hasSystemPermission(args.login, args.user, args.perm))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_hasTablePermission(self, seqid, iprot, oprot):
    ...
    result = hasTablePermission_result()
    try:
      result.success = yield gen.maybe_future(self._handler.hasTablePermission(args.login, args.user, args.table, args.perm))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_listLocalUsers(self, seqid, iprot, oprot):
    ...
    result = listLocalUsers_result()
    try:
      result.success = yield gen.maybe_future(self._handler.listLocalUsers(args.login))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_revokeSystemPermission(self, seqid, iprot, oprot):
    ...
    result = revokeSystemPermission_result()
    try:
      yield gen.maybe_future(self._handler.revokeSystemPermission(args.login, args.user, args.perm))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_revokeTablePermission(self, seqid, iprot, oprot):
    ...
    result = revokeTablePermission_result()
    try:
      yield gen.maybe_future(self._handler.revokeTablePermission(args.login, args.user, args.table, args.perm))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_createBatchScanner(self, seqid, iprot, oprot):
    ...
    result = createBatchScanner_result()
    try:
      result.success = yield gen.maybe_future(self._handler.createBatchScanner(args.login, args.tableName, args.options))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_createScanner(self, seqid, iprot, oprot):
    ...
    result = createScanner_result()
    try:
      result.success = yield gen.maybe_future(self._handler.createScanner(args.login, args.tableName, args.options))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_hasNext(self, seqid, iprot, oprot):
    ...
    result = hasNext_result()
    try:
      result.success = yield gen.maybe_future(self._handler.hasNext(args.scanner))
  ...
  def process_nextEntry(self, seqid, iprot, oprot):
    ...
    result = nextEntry_result()
    try:
      result.success = yield gen.maybe_future(self._handler.nextEntry(args.scanner))
  ...
  def process_nextK(self, seqid, iprot, oprot):
    ...
    result = nextK_result()
    try:
      result.success = yield gen.maybe_future(self._handler.nextK(args.scanner, args.k))
    except NoMoreEntriesException as ouch1:
      result.ouch1 = ouch1
    except UnknownScanner as ouch2:
      result.ouch2 = ouch2
  ...
  def process_closeScanner(self, seqid, iprot, oprot):
    ...
    result = closeScanner_result()
    try:
      yield gen.maybe_future(self._handler.closeScanner(args.scanner))
    except UnknownScanner as ouch1:
      result.ouch1 = ouch1
  ...
  def process_updateAndFlush(self, seqid, iprot, oprot):
    ...
    result = updateAndFlush_result()
    try:
      yield gen.maybe_future(self._handler.updateAndFlush(args.login, args.tableName, args.cells))
  ...
  def process_createWriter(self, seqid, iprot, oprot):
    ...
    result = createWriter_result()
    try:
      result.success = yield gen.maybe_future(self._handler.createWriter(args.login, args.tableName, args.opts))
    except AccumuloException as outch1:
      result.outch1 = outch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_update(self, seqid, iprot, oprot):
    ...
    args.read(iprot)
    iprot.readMessageEnd()
    yield gen.maybe_future(self._handler.update(args.writer, args.cells))
  ...
  def process_flush(self, seqid, iprot, oprot):
    ...
    result = flush_result()
    try:
      yield gen.maybe_future(self._handler.flush(args.writer))
  ...
  def process_closeWriter(self, seqid, iprot, oprot):
    ...
    result = closeWriter_result()
    try:
      yield gen.maybe_future(self._handler.closeWriter(args.writer))
    except UnknownWriter as ouch1:
      result.ouch1 = ouch1
    except MutationsRejectedException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_updateRowConditionally(self, seqid, iprot, oprot):
    ...
    result = updateRowConditionally_result()
    try:
      result.success = yield gen.maybe_future(self._handler.updateRowConditionally(args.login, args.tableName, args.row, args.updates))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_createConditionalWriter(self, seqid, iprot, oprot):
    ...
    result = createConditionalWriter_result()
    try:
      result.success = yield gen.maybe_future(self._handler.createConditionalWriter(args.login, args.tableName, args.options))
    except AccumuloException as ouch1:
      result.ouch1 = ouch1
    except AccumuloSecurityException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_updateRowsConditionally(self, seqid, iprot, oprot):
    ...
    result = updateRowsConditionally_result()
    try:
      result.success = yield gen.maybe_future(self._handler.updateRowsConditionally(args.conditionalWriter, args.updates))
    except UnknownWriter as ouch1:
      result.ouch1 = ouch1
    except AccumuloException as ouch2:
      result.ouch2 = ouch2
  ...
  def process_closeConditionalWriter(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = closeConditionalWriter_result()
    yield gen.maybe_future(self._handler.closeConditionalWriter(args.conditionalWriter))
  ...
  def process_getRowRange(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = getRowRange_result()
    result.success = yield gen.maybe_future(self._handler.getRowRange(args.row))
  ...
  def process_getFollowing(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = getFollowing_result()
    result.success = yield gen.maybe_future(self._handler.getFollowing(args.key, args.part))
